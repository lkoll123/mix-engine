...
class MixEngine:
    ...
    def __comp_tone_alignment(self, chroma_1: list[float], chroma_2: list[float]) -> float:
        """
    ...
    def get_similarity_det(self, song_1: str, song_2: str, weights: list[float] = [0.26, 0.33, 0.23, 0.08, 0.1]) -> float:
        """ 
